...
**Link**: [Official Documentation](https://core.telegram.org/bots/api#inputmediaanimation)
...
|---|---|---|---|
| type | String | Yes | Type of the media, must be animation |
...
| parse_mode | String | Optional | Optional. Mode for parsing entities in the animation caption. See formatting options for more details. |
...
| width | Integer | Optional | Optional. Animation width |
| height | Integer | Optional | Optional. Animation height |
| duration | Integer | Optional | Optional. Animation duration in seconds |
| has_spoiler | Boolean | Optional | Optional. Pass True if the animation needs to be covered with a spoiler animation |
