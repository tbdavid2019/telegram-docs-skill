...
**Link**: [Official Documentation](https://core.telegram.org/bots/api#chatmemberadministrator)
...
| can_be_edited | Boolean | Yes | True, if the bot is allowed to edit administrator privileges of that user |
