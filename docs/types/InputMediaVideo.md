...
**Link**: [Official Documentation](https://core.telegram.org/bots/api#inputmediavideo)
...
| has_spoiler | Boolean | Optional | Optional. Pass True if the video needs to be covered with a spoiler animation |
