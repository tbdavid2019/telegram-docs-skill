...
**Link**: [Official Documentation](https://core.telegram.org/bots/api#inlinequeryresultvoice)
...
| voice_duration | Integer | Optional | Optional. Recording duration in seconds |
